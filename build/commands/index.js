...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../lib/emojis.js":[function(require,module,exports) {
"use strict";
...
},{}],"../components/setupForm.js":[function(require,module,exports) {
"use strict";
...
var _inkConfirmInput = _interopRequireDefault(require("@pheonixcoder/ink-confirm-input"));
...
class SetupForm extends _react.Component {
  constructor() {
    super();
    this.state = {
      setup: false,
  ...
  render() {
    return _react.default.createElement(_ink.Box, {
      ...
      bold: true
    }, "Config Not Found"), _react.default.createElement(_ink.Box, {
      marginBottom: 2
    }, _react.default.createElement(_ink.Text, null, "This Machine is not setup. Do you want to setup?"), _react.default.createElement(_inkConfirmInput.default, {
      value: this.state.setup,
      onChange: this.changeConfigSetup,
...
var _emojis = require("../lib/emojis");

var _setupForm = _interopRequireDefault(require("../components/setupForm"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

class Sinc extends _react.Component {
  constructor() {
    super();
    const machine = {
      name: (0, _os.hostname)(),
    ...
    this.state = (0, _fs.existsSync)((0, _path.resolve)((0, _os.homedir)(), '.sincrc')) ? JSON.parse((0, _fs.readFileSync)((0, _path.resolve)((0, _os.homedir)(), '.sincrc'), 'utf8')) : {
      version: 1,
      Identifier: hash,
      Machine: machine,
      syncedItems: [],
  ...
  saveConfig(newConfig) {
    if (newConfig.setup) {
      ...
      (0, _fs.writeFileSync)((0, _path.resolve)((0, _os.homedir)(), '.sincrc'), JSON.stringify(this.state, (key, value) => {
        if (key === '_ui') {
          return undefined;
        }
  ...
  render() {
    return _react.default.createElement(_ink.Box, {
      ...
      margin: 2
    }, _react.default.createElement(_ink.Text, null, "Sinc 1.0.0")), _react.default.createElement(_ink.Box, {
      marginBottom: 2,
      flexDirection: "column"
    }, _react.default.createElement(_ink.Text, {
      bold: true
    }, "Machine Identifier ", this.state.setup ? _emojis.Emojis.white_check_mark : _emojis.Emojis.warning), _react.default.createElement(_ink.Text, null, this.state.Machine.name, " ", this.state.Machine.platform), _react.default.createElement(_ink.Text, null, this.state.Identifier)), !this.state.setup && !this.state._ui.setupAborted && _react.default.createElement(_setupForm.default, {
      onSave: this.saveConfig
    }), !this.state.setup && this.state._ui.setupAborted && _react.default.createElement(_ink.Box, null, _react.default.createElement(_ink.Text, null, "All Good. No setup done. See you soon.")));
  }
...
var _default = Sinc;
exports.default = _default;
},{"../lib/emojis":"../lib/emojis.js","../components/setupForm":"../components/setupForm.js"}]},{},["index.js"], null)
